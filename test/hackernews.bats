...
@test "hackernews module (csv)" {
  ...
  [ "$status" -eq 0 ]
  [[ "$output" =~ ^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z,hackernews,hackernews,karma,[0-9]+$ ]]
}
...
@test "hackernews module (tsv)" {
  ...
  [ "$status" -eq 0 ]
  [[ "$output" =~ ^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z${tab}hackernews${tab}hackernews${tab}karma${tab}[0-9]+$ ]]
}
