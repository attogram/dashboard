...
@test "discord module (csv)" {
  ...
  [ "$status" -eq 0 ]
  [[ "$output" =~ ^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z,discord,discord,online,[0-9]+$ ]]
}
...
@test "discord module (tsv)" {
  ...
  [ "$status" -eq 0 ]
  [[ "$output" =~ ^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}Z${tab}discord${tab}discord${tab}online${tab}[0-9]+$ ]]
}
